#!/usr/bin/env python3
"""
Deprecated — use ``scripts/scrape_historical.py --preset icici-nse-trades`` or
...
def main() -> None:
    logger.warning(
        "Deprecated: use scripts/scrape_historical.py --preset icici-nse-trades "
    ...
    with Session(get_engine()) as session:
        r = run_historical_backfill(
            ...
            after=args.after,
            before=args.before,
            gmail_query=HISTORICAL_GMAIL_QUERY_PRESETS["icici-nse-trades"],
            dry_run=args.dry_run,
        )
    print()
    print("=== Historical sweep (icici-nse-trades) ===")
